...
#define max_AmpMoyenne 3                                                  //Cette variable sera utilisée pour définir la valeur de réference pour le remplissage du bargraph, exemple : max max_AmpMoyenne est mis à 200 et que la variable à tester atteint la valeur de 100 alors le bargraph fera 50% de la taille de l'écran.
...
const int ReceptionSignal = A0;                                             //Cette pin reçoit le signal à traiter en sortie de l'ampli-op.
/*---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
