...
#define Set_Bit_as_ACK (I2C1CONbits.ACKDT = 0)
#define Set_Bit_as_NACK (I2C1CONbits.ACKDT = 1) 
#define Send_ACK_reg (I2C1CONbits.ACKEN = 1) 							// 1 = Envoie un ACK en mode lecture, le hardware remet le bit à 0 à la fine de l'envoie
#define ACK_in_Progress I2C1CONbits.ACKEN
